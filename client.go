...
import (
	...
	"github.com/mvandergrift/opcua/stats"
...
// #Option for details.
//
// https://godoc.org/github.com/mvandergrift/opcua#Option
...
func (c *Client) Connect(ctx context.Context) error {
	...
	// todo(fs): see the discussion in https://github.com/mvandergrift/opcua/pull/512
			...
			for action != none {
				...
				default:
					...
					case createSecureChannel:
						...
						// todo(fs): down.
						//
						// https://github.com/mvandergrift/opcua/pull/470
						c.conn.Close()
...
func (c *Client) Close(ctx context.Context) error {
	...
	// https://github.com/mvandergrift/opcua/pull/462
	//
...
func (c *Client) ActivateSession(ctx context.Context, s *Session) error {
	...
	return c.SecureChannel().SendRequest(ctx, req, s.resp.AuthenticationToken, func(v interface{}) error {
		...
		//
		// https://github.com/mvandergrift/opcua/issues/474
		//
